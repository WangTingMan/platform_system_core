...
LIBUTILSBINDERSDK_API int strcmp16(const char16_t *, const char16_t *);
LIBUTILSBINDERSDK_API int strncmp16(const char16_t *s1, const char16_t *s2, size_t n);
LIBUTILSBINDERSDK_API size_t strlen16(const char16_t *);
LIBUTILSBINDERSDK_API size_t strnlen16(const char16_t *, size_t);
LIBUTILSBINDERSDK_API char16_t *strstr16(const char16_t*, const char16_t*);
...
LIBUTILSBINDERSDK_API int strzcmp16(const char16_t *s1, size_t n1, const char16_t *s2, size_t n2);

/**
 * Measure the length of a UTF-32 string in UTF-8. If the string is invalid
 * such as containing a surrogate character, -1 will be returned.
 */
LIBUTILSBINDERSDK_API ssize_t utf32_to_utf8_length(const char32_t *src, size_t src_len);
 ...
 * \endcode
 */
LIBUTILSBINDERSDK_API void utf32_to_utf8(const char32_t* src, size_t src_len, char* dst, size_t dst_len);
 ...
 */
LIBUTILSBINDERSDK_API int32_t utf32_from_utf8_at(const char *src, size_t src_len, size_t index, size_t *next_index);


/**
 * Returns the UTF-8 length of UTF-16 string "src".
 */
LIBUTILSBINDERSDK_API ssize_t utf16_to_utf8_length(const char16_t *src, size_t src_len);
 ...
 * NUL terminator.
 */
LIBUTILSBINDERSDK_API void utf16_to_utf8(const char16_t* src, size_t src_len, char* dst, size_t dst_len);
 ...
 */
LIBUTILSBINDERSDK_API ssize_t utf8_to_utf16_length(const uint8_t* src, size_t srcLen, bool overreadIsFatal = false);
 ...
 */
LIBUTILSBINDERSDK_API char16_t* utf8_to_utf16_no_null_terminator(
 ...
 */
LIBUTILSBINDERSDK_API char16_t *utf8_to_utf16(
        const uint8_t* src, size_t srcLen, char16_t* dst, size_t dstLen);
